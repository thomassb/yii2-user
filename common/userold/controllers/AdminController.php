...
use Yii;
use  common\user\models\User;
use  common\user\models\UserKey;
use  common\user\models\UserAuth;
...
class AdminController extends Controller
{
    ...
    public function init()
    {
        ...
        if(  !Yii::$app->user->can("admin")){
             throw new ForbiddenHttpException('You are not allowed to perform this action. fff');
        }
