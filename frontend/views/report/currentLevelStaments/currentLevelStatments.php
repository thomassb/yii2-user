...
$this->title = Yii::t('app', 'Current Level Statements');
...
<div class="box box-default">
    ...
    <div class="box-body">
        ...
        ?>
        <?= $this->render('/common/_pupilSearchForm', ['reportForm' => $reportForm, 'useLevel' => false,
            'useStrand' => false,'useSubject'=>false,'useDate'=>false]) ?>
    ...
    <div class="box box-default">
        ...
        <div class="box-body">
            ...
            echo ReportListView::widget([
                ...
                'summary' => "Showing <b>1</b> of <b>{totalCount}</b> pupils",
                //    'summary' => '',
